    ...
    <TabbedForm>
            ...
            <ArrayInput source="hours" label="Operating Hours">
              <SimpleFormIterator>
                <TextInput
                  ...
                  placeholder="09:00"
                />
                <TextInput source="end" label="End Time" placeholder="17:00" />
              </SimpleFormIterator>
            </ArrayInput>
            <ArrayInput source="lunch" label="Lunch Break (optional)">
              <SimpleFormIterator>
                <TextInput
                  ...
                  placeholder="12:00"
                />
                <TextInput source="end" label="Lunch End" placeholder="13:00" />
              </SimpleFormIterator>
            </ArrayInput>
          </SimpleFormIterator>
        </ArrayInput>
      ...
      <FormTab label="Advanced Options">
        ...
        <TextInput
          ...
          fullWidth
        />
        <ArrayInput source="about_client.description" label="About Description">
          <SimpleFormIterator>
            <TextInput source="" label="Description Point" fullWidth />
          </SimpleFormIterator>
        </ArrayInput>
